...
// TODO: replace all anys with a type

/**
 * Get summoner by Riot ID
 */
export async function getSummoner(req: any, res: any) {
  try {
 ...
 */
export async function getSummonerByPuuidController(req: any, res: any) {
  try {
 ...
 */
export async function getMatchIds(req: any, res: any) {
  try {
    const { puuid } = req.params;
 ...
 */
export async function getMatchHistory(req: any, res: any) {
  try {
    const { gameName, tagLine } = req.params;
